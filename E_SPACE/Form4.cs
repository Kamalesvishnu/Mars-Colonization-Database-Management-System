...
namespace E_SPACE
{
    public partial class Form4 : Form
    {
        ...
        private void Button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into  Astronomers (Astronomers_id,name,Rank,Qualification,jet_unique_code)VALUES('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + comboBox1.Text + "')", con);
                cmd.ExecuteNonQuery();
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update astronomer set name='" + textBox2.Text + "',jet_unique_code='" + comboBox1.Text + "',Rank='" + textBox3.Text + "' where Astronomers_id ='" + textBox1.Text + "'", con);
                cmd.ExecuteNonQuery();
        ...
        {
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("DELETE fROM Astronomers where Astronomers_id = '" + textBox1.Text + "'", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Existing astronomers Details Deleted Successfull", "Astronomers Details Deleted", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM Astronomers  WHERE Astronomers_id ='" + textBox1.Text + "'", con);
            con.Open();
            SqlDataReader sdr = cmd.ExecuteReader();
            if (sdr.Read())
            {
                textBox2.Text = sdr["name"].ToString();
                textBox3.Text = sdr["rank"].ToString();
